...
class _WordsOfAffirmationPageState extends State<WordsOfAffirmationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Positive Words of Affirmations',style: TextStyle( fontFamily: "BUXTONSKETCH",fontWeight: FontWeight.bold),),
      ),
      body: Container(
          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                ...
                minimumSize: Size(270, 90),
              ),
              onPressed: _generateRandomActivity,
              child: Text(
                'Generate Words of Affirmations',
                style: TextStyle(color: Colors.white,fontSize: 23,fontWeight: FontWeight.bold, fontFamily: "BUXTONSKETCH",), // Button text color
              ),
            ),
            SizedBox(height: 16),
            Center(
              child: Text(
                _selectedActivity,
                style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.black, fontFamily: "BUXTONSKETCH",),
